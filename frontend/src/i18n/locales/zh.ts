  ...
  admin: {
    ...
    ops: {
      ...
      runtime: {
        ...
        metricThresholdsHint: '告警评估器使用的触发阈值。',
        slaMinPercent: 'SLA 下限（%）',
        slaMinPercentHint: '当 SLA 滚动指标低于此百分比时触发告警。',
        ttftP99MaxMs: 'TTFT p99 上限（ms）',
        ttftP99MaxMsHint: '当首字延迟 p99 超过此毫秒数时触发告警。',
        requestErrorRateMaxPercent: '请求错误率上限（%）',
        requestErrorRateMaxPercentHint: '当请求错误率超过此百分比时触发告警。',
        upstreamErrorRateMaxPercent: '上游错误率上限（%）',
        upstreamErrorRateMaxPercentHint: '当上游错误率超过此百分比时触发告警。',
        silencing: {
          title: '告警静默（维护模式）',
          enabled: '启用静默',
