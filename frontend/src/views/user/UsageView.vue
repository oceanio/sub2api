      ...
      >
        <div class="space-y-1.5">
          ...
          <div class="mb-2 border-b border-gray-700 pb-1.5">
            ...
            <!-- Per-image billing: show image metadata only; unit price / total price hidden from end user -->
          ...
          <!-- Rate and Summary: cost breakdown hidden from end user, only actual billed remains -->
