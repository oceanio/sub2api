...
type APIKey struct {
	...
	// Team context this key belongs to. nil = personal key (deduct user balance). non-nil = team key (deduct team balance).
...
func (*APIKey) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case apikey.FieldID, apikey.FieldUserID, apikey.FieldGroupID, apikey.FieldTeamID:
