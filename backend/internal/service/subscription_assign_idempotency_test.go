...
func (userSubRepoNoop) ListByTeamID(context.Context, int64, UserSubscriptionTeamFilters, pagination.PaginationParams) ([]UserSubscription, *pagination.PaginationResult, error) {
